                ...
                <div className="space-y-3">
                    {dataPoints.map((point, idx) => (
                        <div key={idx} className="space-y-1">
                            <div className="text-[10px] uppercase tracking-widest text-gray-600 font-bold font-mono">
                                {point.label}
                            </div>
        ...
        <section className="w-full  text-black overflow-hidden relative">
            ...
            <div className="max-w-6xl mx-auto px-6">
                <div className="mb-20 text-center space-y-6">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold tracking-tighter leading-[1.1] mb-6 text-balance text-[#0A0A0A] dark:text-white">Pretty stories vs.
                ...
                <div className="relative max-w-4xl mx-auto mb-3" ref={containerRef}>
                    ...
                    <motion.div
                        ...
                        className="relative bg-white text-gray-900 p-6 md:p-12 lg:p-20 rounded-sm shadow-md border border-gray-100 min-h-[500px]"
                    >
                        {/* Document Header */}
                        <div className="flex justify-between items-end border-b-2 border-gray-900 mb-12 pb-4">
                            <div>
                                <div className="font-black text-2xl md:text-3xl tracking-tighter uppercase">Investment Memo</div>
                                <div className="italic text-gray-600 mt-1 text-xs md:text-sm">Generated by Generic LLM • Nov 21, 2025</div>
                            </div>
                            <div className="font-mono text-[10px] md:text-xs font-bold text-gray-600 border border-gray-200 px-2 py-1 rounded">
                                DOC_ID: 882-XJ-99
                            </div>
                        </div>
                        ...
                        {/* Watermark/Footer */}
                        <div className="absolute bottom-4 md:bottom-8 right-6 md:right-12 opacity-[0.07] font-black text-4xl md:text-6xl -rotate-12 pointer-events-none select-none">
                            UNVERIFIED
                        </div>
                    </motion.div>
                </div>
