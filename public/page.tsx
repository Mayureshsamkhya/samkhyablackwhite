...
//   const next = () => setIdx((p) => cycleIndex(p, 1, images.length))
// -  const prev = () => setIdx((p) => cycleIndex(p, -1, images.length))

//   const renderMockup = (image: CarouselImage, isActive: boolean) => {
...
//           //       <iframe
//           //         src="/executive-brief.pdf#toolbar=0&navpanes=0&zoom=page-width"
//           //         className="w-full h-[800px] bg-white mt-20"
...
//               <div className="space-y-0">
//                 <img
//                   src="/legoai-onepager-1.png"
//                   alt="LEGOAI Technologies - Executive Brief"
//                   className="w-full h-auto object-contain"
//                 />
//                 <img
//                   src="/legoai-onepager-2.png"
...
//   return (
//     <div className="relative w-full overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm ring-1 ring-gray-100">
//       <div className="flex w-full items-center justify-between p-3">
//         <div className="text-sm font-medium text-gray-700">Platform Gallery</div>
//         <div className="flex gap-2">
//           <Button variant="default" size="icon" onClick={prev} aria-label="Previous slide">
//             <ArrowRight className="h-4 w-4 rotate-180" />
//           </Button>
//           <Button variant="default" size="icon" onClick={next} aria-label="Next slide">
//             <ArrowRight className="h-4 w-4" />
//           </Button>
//         </div>
//       </div>
//       <div
//         className="relative min-h-[600px] p-6 overflow-y-auto max-h-[800px]"
...
//             }}
//           >
//             {renderMockup(img, i === idx)}
//             {img.caption && i === idx && (
//               <p className="mt-6 text-center text-sm text-gray-600 max-w-3xl leading-relaxed">{img.caption}</p>
//             )}
//           </div>
//         ))}
//       </div>
...
//             key={i}
//             onClick={() => setIdx(i)}
//             className={`h-2 w-2 rounded-full transition-colors ${i === idx ? "bg-gray-800" : "bg-gray-300"}`}
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <div className="pt-">
        ...
        <section className="relative isolate overflow-hidden bg-gradient-to-b from-white to-gray-50">
          <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-6 pb-14 pt-20 md:grid-cols-12">
            <div className="md:col-span-7">
              <Badge className="mb-3 bg-gray-100 text-gray-700 hover:bg-gray-200" variant="secondary">Case study</Badge>
              <h1 className="text-4xl font-semibold tracking-tight md:text-5xl text-blue-700">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <Button className="rounded-full bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base px-3 sm:px-4 py-1 sm:py-2 transition-all duration-300 hover:scale-105 shadow-md border border-blue-700" size="lg" onClick={onDemoClick} data-analytics-id="cta-hero-demo">
                  Book a demo
                </Button>
              </div>
            ...
            <CarouselContent>
              {galleryImages.map((image, index) => (
                <CarouselItem key={index}>
                  <div className="p-1">
                    <Card>
                      <CardContent className="flex aspect-square items-center justify-center h-[700px]">
